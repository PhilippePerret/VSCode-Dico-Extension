...
(() => {
  ...
  var ClientItem;
  var init_ClientItem = __esm({
    "src/webviews/ClientItem.ts"() {
      "use strict";
      init_SelectionManager();
      ClientItem = class {
        static klass;
  ...
  var VimLikeManager;
  var init_VimLikeManager = __esm({
    "src/webviews/services/VimLikeManager.ts"() {
      "use strict";
      init_DomUtils();
      VimLikeManager = class {
  ...
  var ComplexRpc;
  var init_ComplexRpc = __esm({
    "src/webviews/services/ComplexRpc.ts"() {
      "use strict";
      ComplexRpc = class _ComplexRpc {
  ...
  var allg, genres, EntryForm;
  var init_EntryForm = __esm({
    "src/webviews/models/EntryForm.ts"() {
      "use strict";
      init_UConstants();
      init_ComplexRpc();
      init_FormManager();
      init_Entry();
      allg = Constants.ENTRIES_GENRES;
      genres = Object.keys(allg).map((key) => [key, allg[key]]);
      EntryForm = class _EntryForm extends FormManager {
        formId = "entry-form";
        prefix = "entry";
        properties = [
  ...
  var Entry, EntryPanelClass, EntryPanel, RpcEntry;
  var init_Entry = __esm({
    "src/webviews/models/Entry.ts"() {
      ...
      init_EntryForm();
      init_ComplexRpc();
      Entry = class _Entry extends ClientItem {
        type = "entry";
      ...
      EntryPanelClass = class extends PanelClient {
        get accessTable() {
      ...
      EntryPanel = new EntryPanelClass({
        minName: "entry",
        titName: "Entries",
        klass: Entry,
        form: new EntryForm()
  ...
  var init_App = __esm({
    "src/webviews/services/App.ts"() {
      ...
      App = class {
        static Rpc;
        static async init() {
          const { RpcEntry: RpcEntry2 } = await Promise.resolve().then(() => (init_Entry(), Entry_exports));
          this.Rpc = RpcEntry2;
  ...
  var init_class_extensions = __esm({
    "src/bothside/class_extensions.ts"() {
      "use strict";
  ...
  var PanelClient;
  var init_PanelClient = __esm({
    "src/webviews/PanelClient.ts"() {
      "use strict";
      init_ConsoleManager();
      init_HelpManager();
      init_VimLikeManager();
      init_class_extensions();
      PanelClient = class {
        // ========== A P I ================
        context = "start";
        form;
