...
(() => {
  ...
  var Exemple = class _Exemple extends ClientItem {
    ...
    static sendIdCurrentToDefinition() {
      ...
      if (exempleId) {
        RpcEx.notify("send-id-exemple-to-definition", { exempleId });
      } else {
        this.panel.flash("Il faut choisir l\u2019exemple dont il faut envoyer l\u2019id\xA0!", "warn");
      }
    }
  };
  var ExemplePanelClass = class extends PanelClient {
     ...
     */
    showExemple(oeuvreId, indice = void 0) {
      if (indice === void 0) {
        [oeuvreId, indice] = oeuvreId.split(":");
      }
      const selector = `main#items div.exemple[data-id="${oeuvreId}-${indice}"]`;
      this.scrollTo(this.container.querySelector(selector));
